...
const computeNumberOfCellsVertical = () => {
  const numberOfCellsVertical =
    HEIGHT_SCREEN / (WIDTH_SCREEN / NUMBER_OF_CELLS_HORIZONTAL);
...
const HEIGHT_SCREEN = Dimensions.get('window').height - 85;
